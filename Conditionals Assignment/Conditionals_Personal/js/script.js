...
var layerCost = cakeMixPrice + eggsPrice + oilPrice + frostingPrice;

if( layerCost * 3 >= moneyAvail - costPresent ){
   alert("You can make the 3-layered cake and buy the present!");
}else if( layerCost * 2 >= moneyAvail - costPresent ){
    alert("You can only make a double-layered cake to afford the present!");
}else if( layerCost >= moneyAvail - costPresent ){
